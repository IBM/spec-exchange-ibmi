...
BuildRequires:    gettext-runtime, libintl-devel
...
%configure \
	...
	--with-libunistring-prefix=%{_prefix} \
...
%{_libdir}/%{name}.so.*
%{_datadir}/locale/*/LC_MESSAGES/libidn2.mo
...
%changelog
* Thu May 14 2020 Calvin Buckley <calvin@seidengroup.com> - 2.3.0-4seiden
- SG rebuild

* Thu May 14 2020 Calvin Buckley <calvin@cmpct.info> - 2.3.0-3qsecofr
- PASE
